...
UPhysicsPublisherComponent::UPhysicsPublisherComponent(
...
void UPhysicsPublisherComponent::TickComponent(
  ...
  FActorComponentTickFunction* ThisTickFunction) {
    ...
    if (EnablePose && PoseAd == nullptr) {
        ...
        PoseAd = U_geometry_msgs_PoseAdvertiser::Create_Pose_Advertiser(
          ActorName + "/pose");
    }
    if (EnableTwist && TwistAd == nullptr) {
        TwistAd = U_geometry_msgs_TwistAdvertiser::Create_Twist_Advertiser(
          ActorName + "/twist");
    }
    if (EnableAccel && AccelAd == nullptr) {
        AccelAd = U_geometry_msgs_AccelAdvertiser::Create_Accel_Advertiser(
          ActorName + "/accel");
    }
